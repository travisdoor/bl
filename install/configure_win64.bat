...
(
  ...
  echo. */
  echo.
  echo.// Main API directory containing all modules and source files.
  echo.LIB_DIR "%LIB_DIR%"
  echo.// Native linker executable. 
  ...
  echo.LINKER_OPT "kernel32.lib user32.lib gdi32.lib shell32.lib ucrt.lib legacy_stdio_definitions.lib msvcrt.lib vcruntime.lib Shlwapi.lib"
  echo.// Linker options used for debug linking.
  echo.LINKER_OPT_DEBUG "kernel32.lib user32.lib gdi32.lib shell32.lib ucrtd.lib legacy_stdio_definitions.lib msvcrtd.lib vcruntimed.lib Shlwapi.lib"
