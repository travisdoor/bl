...
- [-] Enum [8/9]
  ...
  - [ ] All expressions passed into evaluation must be validated by check as consts 
...
- [-] Array [4/9]
  ...
  - [ ] Array definition size as const expr 
...
- [-] Other [3/7]
  ...
  - [ ] Check const = ? -> constants cannot be modified at runtime!!!
