...
** Compound expressions
   Compound expression can be used for inline initialization of variables or directly as an explicit value..
   Implicit temporary variable is created when needed. Zero initializer can be used as short for memset(0) call.
